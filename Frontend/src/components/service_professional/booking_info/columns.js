import { h } from 'vue'
import DropdownAction from '@/components/service_professional/booking_info/DataTableDropDown.vue'
import { format } from 'date-fns'


export function getColumns(handleCancelBooking, handleCompletedBooking) {
  return [
    {
    ...
    },
    {
      ...
      cell: ({ row }) => {
        const price = row.original.currency + " " + row.getValue('price');
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return h(DropdownAction, {
          ...
          onComplete: handleCompletedBooking,
