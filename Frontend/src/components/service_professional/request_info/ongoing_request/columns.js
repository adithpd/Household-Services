import { h } from 'vue'
import DropdownAction from '@/components/service_professional/request_info/ongoing_request/DataTableDropDown.vue'
import { format } from 'date-fns'


export function getColumns(handleAcceptRequest) {
  return [
    {
